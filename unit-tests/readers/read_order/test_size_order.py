...
class TestLoad(TestCase):
    def test_get_order(self):
        empty_file = open('unit-tests/readers/read_order/sources/empty.c', 'r')
        min_file = open('unit-tests/readers/read_order/sources/min.c', 'r')
        max_file = open('unit-tests/readers/read_order/sources/max.c', 'r')
