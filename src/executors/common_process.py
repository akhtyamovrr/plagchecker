...
def run(source_directory, attribute_values, tokens_values, mapping, settings):
    ...
    further_comparison = attribute_runner.compare(metric_counters, source_string, attribute_values, 0.4)
    ...
    similarity = token_comparison_runner.compare(comparators, tokens_string, tokens_to_compare, 0)
